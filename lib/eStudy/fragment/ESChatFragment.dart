...
import 'package:vistech/eStudy/screen/ESChatScreen.dart';
        ...
        appBar: PreferredSize(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                borderRadius: radius(20), color: grey.withOpacity(0.1)),
            child: Row(
                ...
                children: list_data.map(
                  (data) {
                    return SettingItemWidget(
                      ...
                      leading: commonCacheImageWidget(data.image.validate(), 50,
