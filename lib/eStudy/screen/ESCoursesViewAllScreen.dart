...
class ESCoursesViewAllScreen extends StatefulWidget {
  final List<ESModel>? list_degree;

  ESCoursesViewAllScreen({this.list_degree});

  @override
  ESCoursesViewAllScreenState createState() => ESCoursesViewAllScreenState();
}

class ESCoursesViewAllScreenState extends State<ESCoursesViewAllScreen> {
  @override
  void initState() {
    super.initState();
    init();
