...
import 'package:vistech/eStudy/utils/Colors.dart';
...
InputDecoration ESinputDecoration(BuildContext context,
...
commonSocialButton(
    {BuildContext? context, IconData? icon, String? name, Color? color}) {
  return Container(
    alignment: Alignment.center,
    width: context!.width() * 0.42,
    padding: EdgeInsets.all(8),
    decoration: boxDecorationWithRoundedCorners(
        border: Border.all(color: color!), backgroundColor: context.cardColor),
    child: Row(
