...
import 'package:vistech/theme/theme_type.dart';
    ...
    Widget singleLoading = Shimmer.fromColors(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                padding: FxSpacing.only(bottom: 12),
                child: Container(
                  height: 8,
                  width: 120,
                  color: Colors.grey,
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: Container(
                        padding: FxSpacing.horizontal(8.0),
                        height: 64,
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
      ...
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              padding: FxSpacing.only(top: 32.0, bottom: 16),
              child: Container(
                height: 16,
                width: 120,
                color: Colors.grey,
