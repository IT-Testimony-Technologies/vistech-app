...
import 'handyman_home_screen.dart';
import 'handyman_past_screen.dart';
            ...
            bottomNavigationBar: BottomAppBar(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: customTheme.shadowColor.withAlpha(150),
                        blurRadius: 3,
                        offset: Offset(0, -3),
                      ),
                    ],
                  ),
                  padding: FxSpacing.only(top: 12, bottom: 12),
                  child: TabBar(
