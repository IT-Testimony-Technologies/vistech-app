import 'package:vistech/snippets/APIIntergration/model/AppListinModel.dart';

import 'network_utils.dart';

/// GET method demo
Future<AppListingModel> getUserList(int page) async {
  return AppListingModel.fromJson(
      await (handleResponse(await getRequest('api/users?page=$page'))));
}
...
Future<AppListingModel> deleteUser(int id) async {
  return AppListingModel.fromJson(
      await (handleResponse(await deleteRequest('api/users/$id'))));
}
