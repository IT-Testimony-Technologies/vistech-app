          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text("Simple Chip", style: boldTextStyle()),
              ),
              Row(
                children: [
                  Chip(
              ...
              Padding(
                ...
                child: Text("Choice Chip", style: boldTextStyle()),
              ),
              Wrap(
              ...
              Padding(
                padding: const EdgeInsets.fromLTRB(16, 16, 16, 8),
                child: Text("Filter Chip", style: boldTextStyle()),
              ),
              Wrap(
                children: List<Widget>.generate(
                  3,
                  (int index) {
                    return FilterChip(
                      label: Text('Item $index'),
                      labelStyle: TextStyle(color: _value1 == index ? white : appBarBackgroundColor),
                      selected: _value1 == index,
                      selectedColor: appPrimaryColor,
                      checkmarkColor: appBarBackgroundColor,
                      onSelected: (bool selected) {
                        setState(() {
                          _value1 = index;
                        });
                ...
                children: List<Widget>.generate(
                  ...
                  (int index) {
                    return FilterChip(
                      ...
                      labelStyle: TextStyle(color: _value2 == index ? white : appBarBackgroundColor),
              ...
              ActionChip(
                ...
                label: Text('${isSelected ? 'Downloading...' : 'Download'}', style: primaryTextStyle()),
              ...
              Padding(
                padding: const EdgeInsets.fromLTRB(16, 16, 16, 8),
                child: Text("Multi Selection", style: boldTextStyle()),
              ),
              MultiSelectChip(
                programmingList,
